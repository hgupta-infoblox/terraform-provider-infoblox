...
page_title: "infoblox_ldap_auth_service Resource - terraform-provider-infoblox"
subcategory: "SECURITY"
description: |-
  Manages an Infoblox LdapAuthService in the NIOS backend.
---

# infoblox_ldap_auth_service (Resource)
...
- `servers` (Attributes List) The list of LDAP servers used for authentication. (see [below for nested schema](#nestedatt--nios--servers))
...
- `ea_mapping` (Attributes List) The mapping LDAP fields to extensible attributes. (see [below for nested schema](#nestedatt--nios--ea_mapping))
...
<a id="nestedatt--nios--ea_mapping"></a>
### Nested Schema for `nios.ea_mapping`
