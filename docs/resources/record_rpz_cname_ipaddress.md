...
// Block IP Address (No Such Domain) Rule — omit canonical to send empty value
resource "infoblox_record_rpz_cname_ipaddress" "block_no_domain" {
  nios = {
    name    = "11.0.0.2.rpzip.example.com"
    rp_zone = "rpzip.example.com"
  }
}
