...
resource "infoblox_radius_authservice" "radius_authservice_with_basic_fields" {
  nios = {
...
resource "infoblox_radius_authservice" "radius_authservice_with_additional_field" {
  nios = {
