...
var (
	_ list.ListResource                   = &SmartfolderPersonalList{}
	_ list.ListResourceWithConfigure      = &SmartfolderPersonalList{}
	_ list.ListResourceWithValidateConfig = &SmartfolderPersonalList{}
)

func NewSmartfolderPersonalList() list.ListResource {
	return &SmartfolderPersonalList{}
}

type SmartfolderPersonalList struct {
	backend core.BackendType
	service coresvc.SmartfolderPersonalService
}

type SmartfolderPersonalListModel struct {
	Filters types.Map `tfsdk:"filters"`
}

func (l *SmartfolderPersonalList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_smartfolder_personal"
}

func (l *SmartfolderPersonalList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewSmartfolderPersonalService(l.backend, client.NIOS, client.UDDI)
}

func (l *SmartfolderPersonalList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox SmartfolderPersonal from the NIOS backend.",
...
func (l *SmartfolderPersonalList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data SmartfolderPersonalListModel
...
func (l *SmartfolderPersonalList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data SmartfolderPersonalListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_smartfolder_personal list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.SmartfolderPersonal
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.SmartfolderPersonal, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.SmartfolderPersonal, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list SmartfolderPersonal records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
