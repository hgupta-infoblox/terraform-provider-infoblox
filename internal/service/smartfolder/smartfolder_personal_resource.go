...
var (
	_ resource.Resource                   = &SmartfolderPersonalResource{}
	_ resource.ResourceWithValidateConfig = &SmartfolderPersonalResource{}
	_ resource.ResourceWithConfigure      = &SmartfolderPersonalResource{}
	_ resource.ResourceWithImportState    = &SmartfolderPersonalResource{}
	_ resource.ResourceWithIdentity       = &SmartfolderPersonalResource{}
)
...
func (r *SmartfolderPersonalResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *SmartfolderPersonalResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *SmartfolderPersonalResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox SmartfolderPersonal in the NIOS backend.",
		Attributes:          SmartfolderPersonalResourceSchemaAttributes,
	}
}

func (r *SmartfolderPersonalResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewSmartfolderPersonalService(r.backend, client.NIOS, client.UDDI)
}

func (r *SmartfolderPersonalResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.SmartfolderPersonal](r.backend, op)
}

func (r *SmartfolderPersonalResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateSmartfolderPersonal(ctx, data, resp)
}
...
func (r *SmartfolderPersonalResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.SmartfolderPersonal
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create SmartfolderPersonal: %s", err))
		return
	}
...
func (r *SmartfolderPersonalResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read SmartfolderPersonal: %s", err))
		return
	}
...
func (r *SmartfolderPersonalResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update SmartfolderPersonal: %s", err))
		return
	}
...
func (r *SmartfolderPersonalResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete SmartfolderPersonal: %s", err))
	}
}
