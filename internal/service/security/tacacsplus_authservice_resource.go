...
var (
	_ resource.Resource                   = &TacacsplusAuthserviceResource{}
	_ resource.ResourceWithValidateConfig = &TacacsplusAuthserviceResource{}
	_ resource.ResourceWithConfigure      = &TacacsplusAuthserviceResource{}
	_ resource.ResourceWithImportState    = &TacacsplusAuthserviceResource{}
	_ resource.ResourceWithIdentity       = &TacacsplusAuthserviceResource{}
)
...
func (r *TacacsplusAuthserviceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *TacacsplusAuthserviceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *TacacsplusAuthserviceResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox TacacsplusAuthservice in the NIOS backend.",
		Attributes:          TacacsplusAuthserviceResourceSchemaAttributes,
	}
}

func (r *TacacsplusAuthserviceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewTacacsplusAuthserviceService(r.backend, client.NIOS, client.UDDI)
}

func (r *TacacsplusAuthserviceResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.TacacsplusAuthservice](r.backend, op)
}

func (r *TacacsplusAuthserviceResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateTacacsplusAuthservice(ctx, data, resp)
}
...
func (r *TacacsplusAuthserviceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.TacacsplusAuthservice
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create TacacsplusAuthservice: %s", err))
		return
	}
...
func (r *TacacsplusAuthserviceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read TacacsplusAuthservice: %s", err))
		return
	}
...
func (r *TacacsplusAuthserviceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update TacacsplusAuthservice: %s", err))
		return
	}
...
func (r *TacacsplusAuthserviceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete TacacsplusAuthservice: %s", err))
	}
}
