...
var (
	_ resource.Resource                   = &LdapAuthServiceResource{}
	_ resource.ResourceWithValidateConfig = &LdapAuthServiceResource{}
	_ resource.ResourceWithConfigure      = &LdapAuthServiceResource{}
	_ resource.ResourceWithImportState    = &LdapAuthServiceResource{}
	_ resource.ResourceWithIdentity       = &LdapAuthServiceResource{}
)
...
func (r *LdapAuthServiceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *LdapAuthServiceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *LdapAuthServiceResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox LdapAuthService in the NIOS backend.",
		Attributes:          LdapAuthServiceResourceSchemaAttributes,
	}
}

func (r *LdapAuthServiceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewLdapAuthServiceService(r.backend, client.NIOS, client.UDDI)
}

func (r *LdapAuthServiceResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.LdapAuthService](r.backend, op)
}

func (r *LdapAuthServiceResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateLdapAuthService(ctx, data, resp)
}
...
func (r *LdapAuthServiceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.LdapAuthService
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create LdapAuthService: %s", err))
		return
	}
...
func (r *LdapAuthServiceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read LdapAuthService: %s", err))
		return
	}
...
func (r *LdapAuthServiceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update LdapAuthService: %s", err))
		return
	}
...
func (r *LdapAuthServiceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete LdapAuthService: %s", err))
	}
}
