...
var (
	_ resource.Resource                   = &CertificateAuthserviceResource{}
	_ resource.ResourceWithValidateConfig = &CertificateAuthserviceResource{}
	_ resource.ResourceWithConfigure      = &CertificateAuthserviceResource{}
	_ resource.ResourceWithImportState    = &CertificateAuthserviceResource{}
	_ resource.ResourceWithIdentity       = &CertificateAuthserviceResource{}
)
...
func (r *CertificateAuthserviceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *CertificateAuthserviceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *CertificateAuthserviceResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox CertificateAuthservice in the NIOS backend.",
		Attributes:          CertificateAuthserviceResourceSchemaAttributes,
	}
}

func (r *CertificateAuthserviceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewCertificateAuthserviceService(r.backend, client.NIOS, client.UDDI)
}

func (r *CertificateAuthserviceResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.CertificateAuthservice](r.backend, op)
}
...
func (r *CertificateAuthserviceResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateCertificateAuthservice(ctx, data, resp)
}
...
func (r *CertificateAuthserviceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.CertificateAuthservice
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create CertificateAuthservice: %s", err))
		return
	}
...
func (r *CertificateAuthserviceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read CertificateAuthservice: %s", err))
		return
	}
...
func (r *CertificateAuthserviceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update CertificateAuthservice: %s", err))
		return
	}
...
func (r *CertificateAuthserviceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete CertificateAuthservice: %s", err))
	}
}
