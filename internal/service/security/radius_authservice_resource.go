...
var (
	_ resource.Resource                   = &RadiusAuthserviceResource{}
	_ resource.ResourceWithValidateConfig = &RadiusAuthserviceResource{}
	_ resource.ResourceWithConfigure      = &RadiusAuthserviceResource{}
	_ resource.ResourceWithImportState    = &RadiusAuthserviceResource{}
	_ resource.ResourceWithIdentity       = &RadiusAuthserviceResource{}
)
...
func (r *RadiusAuthserviceResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *RadiusAuthserviceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
...
func (r *RadiusAuthserviceResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages an Infoblox RadiusAuthservice in the NIOS backend.",
		Attributes:          RadiusAuthserviceResourceSchemaAttributes,
	}
}

func (r *RadiusAuthserviceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.service = coresvc.NewRadiusAuthserviceService(r.backend, client.NIOS, client.UDDI)
}

func (r *RadiusAuthserviceResource) retryPolicy(op retry.Operation) retry.Policy {
	return retry.For[coremodel.RadiusAuthservice](r.backend, op)
}

func (r *RadiusAuthserviceResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	ValidateRadiusAuthservice(ctx, data, resp)
}
...
func (r *RadiusAuthserviceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	var (
		apiResp  *coremodel.RadiusAuthservice
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create RadiusAuthservice: %s", err))
		return
	}
...
func (r *RadiusAuthserviceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to read RadiusAuthservice: %s", err))
		return
	}
...
func (r *RadiusAuthserviceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update RadiusAuthservice: %s", err))
		return
	}
...
func (r *RadiusAuthserviceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		...
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete RadiusAuthservice: %s", err))
	}
}
