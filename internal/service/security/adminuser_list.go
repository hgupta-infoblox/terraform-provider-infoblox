...
var (
	_ list.ListResource                   = &AdminuserList{}
	_ list.ListResourceWithConfigure      = &AdminuserList{}
	_ list.ListResourceWithValidateConfig = &AdminuserList{}
)

func NewAdminuserList() list.ListResource {
...
func (l *AdminuserList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewAdminuserService(l.backend, client.NIOS, client.UDDI)
}

func (l *AdminuserList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox Adminuser from the NIOS backend.",
...
func (l *AdminuserList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data AdminuserListModel
...
func (l *AdminuserList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data AdminuserListModel
	...
	var records []*coremodel.Adminuser
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.Adminuser, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.Adminuser, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list Adminuser records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
