...
var (
	_ list.ListResource                   = &CertificateAuthserviceList{}
	_ list.ListResourceWithConfigure      = &CertificateAuthserviceList{}
	_ list.ListResourceWithValidateConfig = &CertificateAuthserviceList{}
)

func NewCertificateAuthserviceList() list.ListResource {
	return &CertificateAuthserviceList{}
}

type CertificateAuthserviceList struct {
	backend core.BackendType
	service coresvc.CertificateAuthserviceService
}

type CertificateAuthserviceListModel struct {
	Filters types.Map `tfsdk:"filters"`
}

func (l *CertificateAuthserviceList) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_certificate_authservice"
}

func (l *CertificateAuthserviceList) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	l.service = coresvc.NewCertificateAuthserviceService(l.backend, client.NIOS, client.UDDI)
}

func (l *CertificateAuthserviceList) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{
		MarkdownDescription: "Retrieves a list of Infoblox CertificateAuthservice from the NIOS backend.",
...
func (l *CertificateAuthserviceList) ValidateListResourceConfig(ctx context.Context, req list.ValidateConfigRequest, resp *list.ValidateConfigResponse) {
	var data CertificateAuthserviceListModel
...
func (l *CertificateAuthserviceList) List(ctx context.Context, req list.ListRequest, stream *list.ListResultsStream) {
	var data CertificateAuthserviceListModel
	...
	tflog.Info(ctx, fmt.Sprintf("infoblox_certificate_authservice list: req.Limit=%d backend=%s includeResource=%t",
	...
	var records []*coremodel.CertificateAuthservice
	var err error
	...
	case core.BackendNIOS:
		records, err = core.ReadAllPagesNIOS(
			func(pageID string) ([]*coremodel.CertificateAuthservice, string, error) {
	...
	case core.BackendUDDI:
		records, err = core.ReadAllPagesUDDI(
			func(offset, _ int32) ([]*coremodel.CertificateAuthservice, error) {
	...
	if err != nil {
		diags.AddError("Client Error", fmt.Sprintf("Unable to list CertificateAuthservice records: %s", err))
		stream.Results = list.ListResultsStreamDiagnostics(diags)
		return
	}
